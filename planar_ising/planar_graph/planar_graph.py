...
class PlanarGraph:
    ...
    def get_incident_edge_indices(self, vertex):
        ...
        start_edge_index = int(self._incident_edge_example_indices[vertex])

        yield start_edge_index

        edge_index = int(self._edges.get_next_edge_index(start_edge_index, vertex))

        while edge_index != start_edge_index:

            yield edge_index

            edge_index = int(self._edges.get_next_edge_index(edge_index, vertex))
